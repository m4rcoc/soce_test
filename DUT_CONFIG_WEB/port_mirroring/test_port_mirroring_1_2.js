...
(async function example() {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.css("#table_general_ingressPortMirroring_SWITCH > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2) > input:nth-child(1)")),20000).click() //pulsamos enable egress port

    await driver.wait(until.elementLocated(By.css("#table_ingressPortMirroring_SWITCH > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(4) > input:nth-child(1)")),20000).click() //pulsamos en el ingress J1C mirror ports
    await driver.wait(until.elementLocated(By.css("#table_ingressPortMirroring_SWITCH > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(2) > input:nth-child(1)")),20000).click() //pulsamos en el ingress J1A monitored ports
