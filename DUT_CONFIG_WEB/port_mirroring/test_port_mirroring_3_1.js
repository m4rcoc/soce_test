...
(async function example() {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.css("#table_egressPortMirroring_SWITCH > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(3) > input:nth-child(1)")),20000).click() //pulsamos en el egress J1B monitored ports
