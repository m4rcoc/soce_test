...
(async function example() {
  ...
  try {
    ...
    try{
      ...
      //await driver.get("http://admin:relyum@192.168.2.106/advanced.html")
      ...
      if (webVersion=="new"){
        ...
        await (await driver.wait(until.elementLocated(By.id("u-basic")),4000))
        {
          const element = await driver.findElement(By.id("usr-2"))
