...
def test_rstp_9_1_verifier(test):
    ...
    for i in array_pkts_IF1:
        if STP in i:
            if i[STP].proto==0 and i[STP].version==0 and i[STP].bpdutype==0 and i[STP].bpduflags==0 and i[STP].rootmac=='00:bf:cb:fc:bf:c0' and i[STP].pathcost==400000 and i[STP].bridgemac==regional_root and i[STP].age==0.0 and i[STP].maxage==20.0 and i[STP].hellotime==2.0 and i[STP].fwddelay==15.0 :
                pass_=1
                break
