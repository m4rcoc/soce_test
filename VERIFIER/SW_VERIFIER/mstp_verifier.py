...
def test_mstp_9_2_verifier(test):
    ...
    for i in array_pkts_IF1:
        ...
        if frame_mstp==1:
            if frames["port_id"]=="001c" and count==0:
                count=count+1
            if frames["port_id"]=="601c" and count==1:
                count=count+1
            if frames["port_id"]=="a01c" and count==2:
                count=count+1      
                break
    if count==3:
        pass_=1
    ...
    if pass_==1:
        ...
        for i in array_pkts_IF1:
            ...
            if frame_mstp==1:
                if frames["port_id"]=="201b" and count==0:
                    count=count+1
                if frames["port_id"]=="701b" and count==1:
                    count=count+1
                if frames["port_id"]=="d01b" and count==2:
                    count=count+1      
                    break
        if count==3:
            pass_=1
    ...
    if pass_==1:
        ...
        for i in array_pkts_IF1:
            ...
            if frame_mstp==1:
                if frames["port_id"]=="501a" and count==0:
                    count=count+1
                if frames["port_id"]=="901a" and count==1:
                    count=count+1
                if frames["port_id"]=="f01a" and count==2:
                    count=count+1      
                    break
        if count==3:
            pass_=1
...
def test_mstp_9_3_verifier(test):
    ...
    for i in array_pkts_IF1:
        ...
        if frame_mstp==1:
            if frames["port_id"]!="a01c" and frames["port_id"]!="101c" and frames["port_id"]!="801c":
                pass_=0
                break
    ...
    if pass_==1:
        ...
        for i in array_pkts_IF1:
            ...
            if frame_mstp==1:
                if frames["port_id"]!="d01b" and frames["port_id"]!="801b" and frames["port_id"]!="101b":
                    pass_=0
                    break
    if pass_==1:
        array_pkts_IF1=rdpcap(debug_path+"VERIFIER/Report/"+data["model"]+"/"+config_type+"/"+func+"/"+test+"/"+test+"_captured_IF3.pcap") 
        ...
        for i in array_pkts_IF1:
            ...
            if frame_mstp==1:
                if frames["port_id"]!="f01a" and frames["port_id"]!="101a" and frames["port_id"]!="801a":
                    pass_=0
                    break
    now = datetime.now()
...
def test_mstp_19_1_verifier(test):
    ...
    if pass_==1:
        ...
        for i in array_pkts_IF1:
            ...
            if frame_mstp==1:
                if frames["mstd_prior"][0]=="9001" and frames["mstd_prior"][1]=="a001" and frames["mac_src"]!="aa:aa:aa:aa:aa:aa":
                    pass_=1
                    break
