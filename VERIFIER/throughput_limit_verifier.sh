...
function test_throughput_limit_1_1_verifier(){

# Import stats from Ixia VM
mkdir -p VERIFIER/Report/$config_type/${func}/${test_function}

flow_stats="VERIFIER/Report/$config_type/${func}/${test_function}/STEP3_${test_function}_Flow_Statistics_1G.stats"
port_stats="VERIFIER/Report/$config_type/${func}/${test_function}/STEP3_${test_function}_Port_Statistics_1G.stats"

import_ixia_stats "c:\\test\\reports\\${test_function}\\STEP3_${test_function}_Flow_Statistics_1G.txt" $flow_stats
import_ixia_stats "c:\\test\\reports\\${test_function}\\STEP3_${test_function}_Port_Statistics_1G.txt" $port_stats
