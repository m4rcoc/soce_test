...
timeout 25 tcpdump -i $IF3 ether src 00:AA:AA:AA:AA:AA -w VERIFIER/Report/$config_type/${func}/$test_function/${test_function}_captured_IF3.pcap &
...
print_info "\tWaiting for 10 seconds (Forget time)" | tee -a REPORTS/${func}/${test_function}.out
sleep 9
