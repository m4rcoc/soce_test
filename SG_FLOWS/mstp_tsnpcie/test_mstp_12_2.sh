...
stp set_bridge_param br0 bridge_hello_time 1
stp restart
exit
sleep 10
soce_cli
stp set_bridge_param br0 bridge_hello_time 3
stp restart
exit
sleep 10
soce_cli
stp set_bridge_param br0 bridge_hello_time 10
stp restart
exit
sleep 30
soce_cli
stp set_bridge_param br0 bridge_hello_time 100
stp restart
exit
sleep 60
soce_cli
