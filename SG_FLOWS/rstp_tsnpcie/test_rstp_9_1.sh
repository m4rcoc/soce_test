...
echo VERIFIER/Report/$model/$config_type/${func}/$test_function/
...
sudo python3 SW/RSTP_MSTP/change_macsrc.py SW/RSTP_MSTP/RSTP_app/RSTP_frame_format/MigratePort2STP $MAC_IF2
