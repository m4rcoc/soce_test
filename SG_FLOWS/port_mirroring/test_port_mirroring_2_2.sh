...
sudo python3 ${sw_dir}soce_generator.py --iface=$IF1 --iface_read=$IF3 --filejson="SG_FLOWS/${func}/${test_function}_f3.json" --start --config_type=$config_type
sudo python3 ${sw_dir}soce_generator.py --iface=$IF4 --iface_read=$IF3 --filejson="SG_FLOWS/${func}/${test_function}_f4.json" --start --config_type=$config_type
