...
timeout 10 tcpdump -i $IF1 -w $cap_IF1 &
timeout 10 tcpdump -i $IF2 -w $cap_IF2 &
timeout 10 tcpdump -i $IF3 -w $cap_IF3 &

tcpreplay -i $IF1 SG_FLOWS/${func}/prp_ptp_pdel_req.pcap
