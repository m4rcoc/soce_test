...
echo VERIFIER/Report/$model/$config_type/${func}/$test_function/${test_function}_f1/
...
sudo python3 ${sw_dir}soce_generator.py --iface=$IF2  --filejson="SG_FLOWS/${func}/${test_function}_f2.json" --start --config_type=$config_type --model=$model
