...
print_info "$IF1 / $func / $test_function"
...
# fast_soce_cli "
# statistics get_rx_basic_statistics OP1CD
# statistics get_tx_basic_statistics OP1CD
# statistics get_rx_advanced_statistics OP2CD
# statistics get_tx_advanced_statistics OP2CD
# " -r
