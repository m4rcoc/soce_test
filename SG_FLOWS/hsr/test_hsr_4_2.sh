...
timeout 5 tcpdump -i $IF1 ether dst 00:CC:CC:CC:CC:CC -w VERIFIER/Report/$config_type/${func}/$test_function/${test_function}_captured_IF1.pcap &
timeout 5 tcpdump -i $IF3 ether dst 00:CC:CC:CC:CC:CC -w VERIFIER/Report/$config_type/${func}/$test_function/${test_function}_captured_IF3.pcap &
