...
timeout 12 tcpdump -i $IF1 -w $cap_IF1 &
timeout 12 tcpdump -i $IF2 -w $cap_IF2 &
timeout 12 tcpdump -i $IF3 -w $cap_IF3 &

tcpreplay -i $IF2 SG_FLOWS/${func}/tcpreplay_pdel_req_hsr_tagged_10f.pcap
