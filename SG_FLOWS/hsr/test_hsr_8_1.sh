...
sudo timeout 5 tcpdump -i $IF3 ether src 00:aa:aa:aa:aa:aa or ether src 00:cc:cc:cc:cc:cc -w VERIFIER/Report/$config_type/${func}/$test_function/${test_function}_captured_IF3.pcap &
